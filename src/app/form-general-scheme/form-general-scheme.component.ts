...
@Component({
  selector: 'app-form-general-scheme',
  standalone: true,
  imports: [FormsModule, CommonModule, InputTextModule, InputNumberModule, ButtonModule],
  templateUrl: './form-general-scheme.component.html',
  styleUrl: './form-general-scheme.component.css'
})
export class FormGeneralSchemeComponent {
  // Opciones de sector
  sectorOptions = [
